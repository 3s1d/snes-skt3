...
void S9xDeinitUpdate_org(int width, int height)
{
...
const char* S9xGetDirectory_org(uint32_t dirtype) { return NULL; }

void S9xMessage_org(int a, int b, const char* msg)
{
   if (log_cb)
